...
val_images = get_filenames("validation-images/Categorie1") + get_filenames("validation-images/Categorie2")
train_images = get_filenames("training-images/Categorie1") + get_filenames("training-images/Categorie2")
